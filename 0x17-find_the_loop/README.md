# [Find the Loop](https://intranet.hbtn.io/projects/472)
...
<div class="panel panel-default" id="project-description">
 <div class="panel-body">
  ...
  <ul>
   ...
   <li>
    No standard library functions allowed. Any use of functions like
    <code>
     printf
    </code>
    ,
...
[--LINK PROJECT--](https://intranet.hbtn.io/projects/472)
</html>